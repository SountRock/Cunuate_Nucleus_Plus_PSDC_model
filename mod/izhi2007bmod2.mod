COMMENT
  Izhikevich EM (2007) mini-model.

Cell types based on Izhikevich, 2007:
    1. RS - Layer 5 regular spiking pyramidal cell 
    2. IB - Layer 5 intrinsically bursting cell
    3. CH - Cat primary visual cortex chattering cell 
    4. LTS - Rat barrel cortex Low-threshold  spiking interneuron 
    5. FS - Rat visual cortex layer 5 fast-spiking interneuron 
    6. TC - Cat dorsal LGN thalamocortical (TC) cell 
    7. RTN - Rat reticular thalamic nucleus (RTN) cell  
